...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not found and target tables could not be determined. Please publish the package configuration before proceeding, or drop the tables manually.');
        }
